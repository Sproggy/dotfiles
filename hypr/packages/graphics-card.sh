...
2)
  sudo pacman -S --noconfirm xf86-video-amdgpu mesa lib32-mesa vulkan-radeon lib32-vulkan-radeon  vdpauinfo corectrl lib32-libvdpau #mesa-vdpau lib32-mesa-vdpau libva-mesa-driver lib32-libva-mesa-driver
